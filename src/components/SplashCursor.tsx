...
export default function SplashCursor({
  ...
  useEffect(() => {
    ...
    function blit(gl: WebGLRenderingContext | WebGL2RenderingContext, target: FBO | null, doClear = false) {
      if (!gl) return;
      if (!target) {
